...
<div class="border rounded-1 p-3 d-inline">`r shiny::icon("basket-shopping", class = "fa-light")`</div>
::: {.summary-details}
...
::: {.summary-section .d-flex .flex-grow-1 .gap-1}
<div class="border rounded-1 p-3 d-inline">`r shiny::icon("money-bill-1", class = "fa-light")`</div>
::: {.summary-details}
<span class="cf-title">Compras y retiros</span><br>
RD$ 15,584.77
:::
...
::: {.summary-section .d-flex .flex-grow-1 .gap-1}
<div class="border rounded-1 p-3 d-inline">`r shiny::icon("circle-dollar-to-slot", class = "fa-light")`</div>
::: {.summary-details}
<span class="cf-title">Compras y retiros</span><br>
RD$ 15,584.77
:::
